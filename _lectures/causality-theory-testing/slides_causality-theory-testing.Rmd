...
date: "4 Nov 2025<br>Updated: `r gsub(' 0', ' ', format(Sys.Date(), format='%d %b %Y'))`"
output:
...
For a primer, consider Illari & Russo 
]

.pull-right-40[

![](img/illari_russo.jpg)
...
Scientific theories are causal<sup>1</sup>: *They explain **why** things happen*

.footnote[[1] This is subject to some debate]
...
IMPORTANT: IQA next week rescheduled to Monday @ 2 PM


* Practice drawing DAGs of theories you learn in your other courses!

* Use DAGs in your dissertation if applicable