...
date: "10 Oct 2022<br>Updated: `r gsub(' 0', ' ', format(Sys.Date(), format='%d %b %Y'))`"
output:
...
* What causes $y$?
   ...
   * *What causes desistance from crime over the life-course?*

* What does $x$ cause?

   * *Does clearing a vacant lot reduce nearby crime and fear?*
...
.text-center[
*CRM focuses on **explanatory research** design*
]
...
Causal research usually follows **hypothetico-deductive** framework
...
> Link causal analysis back to descriptive and exploratory, forward to evaluation

> Theories are causal so explanatory, causal research is only way to test theory

> Maybe something about absence of association in exploratory not indicative of absence of causal effect

---
# Wrap-Up

* Theory generates questions
