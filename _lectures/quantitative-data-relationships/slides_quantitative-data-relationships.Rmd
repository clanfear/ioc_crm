...
date: "21 Oct 2025<br>Updated: `r gsub(' 0', ' ', format(Sys.Date(), format='%d %b %Y'))`"
output:
...
.footnote[
At least there's no more calculus!
]
...
sex_offense %>% ggplot(aes(x=Sex, group = Offense, fill = Offense)) + geom_bar() + theme_minimal(base_size = 14) + labs(y = "Frequency") + 
  theme(legend.position = c(0.15, 0.8),
        ...
        panel.background = element_rect(fill="#f0f1eb", color="#f0f1eb"), 
        plot.background = element_rect(fill="#f0f1eb", color="#f0f1eb"),
        legend.background = element_rect(fill="#f0f1eb", color="#f0f1eb"))
```
