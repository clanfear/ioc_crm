...
Critical evaluation of sources---agenda determines what they research
...
There are many different ways to approach topics
...
* Description (‘what does this look like?’):
   ...
   * How does exposure to violence vary over the life course? Over historical periods?
...
* Explanation (‘what explains or accounts for?’)
   ...
   * Does being exposed to violence in childhood make young adults more likely to carry weapons?
...
* Evaluation (‘what works?’)
   ...
   * Does a violence reduction program for at-risk young adults reduce weapon carrying?
...
* Often to develop research questions for explanatory research
...
"Causal Inference<br>Ethnography<br>Grounded Theory<br>Action Research<br>Experiments<br>Case Studies<br>Oral History",
"Interviews<br>Focus Groups<br>Observations<br>Visual Methods<br>Documentary Analysis<br>Questionnaires<br>Structural Models"
) |> kable()
```
...
# A Full 'Methodological Toolbox'

Use the tool appropriate to the research topic/questions
...
distributed through the ranks of the system (Becker, 1967: 241)
...
Does the author convince us of the relevance and topicality of the research?
...
*How well does the study contribute to existing knowledge?*
...
* How well are they justified? 
   * Do they respond to gaps theory?
...
* Is the research design explained and justified?
   ...
   * Is it described in full detail?
   * Does it reference standards?
...
What is the make-up of the actual sample? Does it reflect the intended sample?

Are strengths and limitations of the sample acknowledged?

How effectively will data from this sample answer the research questions or hypotheses?

---

# Data Collection Methods

Are the methods of data collection likely to generate data to answer the research questions effectively?

Are the limitations as well as the strengths of the methods explained?
...
Is there a convincing justification for using a mixed methods approach to the research question?

How well has the design been explained in terms of the purpose, priority, and sequence of methods?

How well has each method been presented in terms of sampling, data collection and analysis?

How effectively have the methods been integrated?

Are there any limitations of one method associated with the presence of the other method?
...
Are the processes of analysis described fully? Are they convincingly rigorous?

Do they make suitable use of the data collected?

Is it clear how analytical themes were derived from the data?
...
* Are the strengths and limitations of the research acknowledged?
...
Scientific research is about understanding how the world works

--

Scientific *theories* are causal *explanations* (beliefs) about how the world works
...
Causal approaches usually follows **hypothetico-deductive** framework
...
Causality isn't necessarily about numbers, nor factors that are physical, behavioural, or even *directly* observable:
   ...
   * Experiences can generate *meanings*
...
Serious crime is more common in neighbourhoods with disorder⁠—litter, panhandlers, and loitering youth
...
* Offenders see disorder as a sign of low social control
...
.text-center[
At the neighbourhood level, disorder causes crime
]
...
* Test if disorder predicts crime when social control is *held constant*
]
.pull-right[
